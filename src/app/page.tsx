    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800">
            ...
            <section className="container mx-auto my-24 px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    { icon: <FaBrain className="text-5xl mb-4" />, title: "Expert Guidance", text: "Our specialists provide professional and personalized care." },
                    { icon: <FaHeart className="text-5xl mb-4" />, title: "Compassionate Support", text: "We prioritize your emotional well-being." },
                    { icon: <FaHandsHelping className="text-5xl mb-4" />, title: "Community Programs", text: "Join support groups and workshops tailored for you." }
                ].map((feature, index) => (
            ...
            <section className="container mx-auto my-24 px-6 font-noto-sans">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
                    {[
                        { icon: <GrUserExpert className="text-5xl mb-4" />, title: "Expert Guidance", text: "Our specialists provide professional and personalized care." },
                        { icon: <FaHeart className="text-5xl mb-4" />, title: "Compassionate Support", text: "We prioritize your emotional well-being." },
                        { icon: <RiUserCommunityLine className="text-5xl mb-4" />, title: "Community Programs", text: "Join support groups and workshops tailored for you." },
                        { icon: <MdModelTraining className="text-5xl mb-4" />, title: "Training Resources", text: "Access professional training and development courses." }
                    ].map((feature, index) => (
