...
export default function FooterForPsychologist() {
  return (
    <footer className="bg-primary-blue text-white py-6 relative bottom-0 w-full">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">MindSpace</h3>
            <p className="text-sm">
              Hỗ trợ sức khỏe tâm thần và cung cấp tài nguyên cho những người
              cần nhất.
            </p>
          </div>
          <div>
